...
public final class Constantes {
	...
	/* On initialise les capteurs de distance au début de Scanner et FastAndFurious
	 * car les initialisations ne sont pas les même
	 */
	
	
    /* Seuils de détection : 
    ces seuils sont plus ou moins calibrés pour notre robot et notre environnement */
